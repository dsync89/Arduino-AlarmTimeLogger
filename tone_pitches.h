...
/*!
	...
	Note pitches for Star Wars Melody 1 (Imperial March) and Star Wars Melody 2 (Star Wars Theme)
...
/** 
  * Tone pitches for Star Wars Melody 1 and Melody 2
  * @author MarieSpliid
...
/** 
  * Tone pitches for Nyan Cat and Tetris
  * @author electricmango
